...
export default function OnboardingPage() {
  ...
  const [createdSlug, set创建dSlug] = React.useState<string | null>(null)
  ...
  return (
    <div className="h-full min-h-0 flex flex-col bg-background">
      {/* 账号 indicator + sign-out, always visible during onboarding */}
            ...
            >
              ...
              <div className="mt-8">
                <input
                  ...
                  onKeyDown={(e) => e.key === 'Enter' && handle创建Wiki()}
