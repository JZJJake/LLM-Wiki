    ...
    <div className="min-h-svh bg-background text-foreground">
      ...
      <section className="pt-32 pb-20 px-6 lg:px-10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            Your LLM compiles and maintains a structured wiki from raw&nbsp;个来源的发现.
          </MotionP>
              ...
              <div className="flex-1 p-8 sm:p-10">
                <div className="max-w-lg">
                  ...
                  <p className="text-xs text-muted-foreground mb-6">
                    12 个来源的发现 &middot; Last updated 2 hours ago
                  </p>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-3">
                    This wiki tracks research on transformer architectures and their scaling properties.
                    它综合了来自 <span className="font-medium text-foreground">12 个来源的发现</span> 跨越 47 页内容。
                  </p>
      ...
      <section className="px-6 lg:px-10 py-24">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">三层架构</h2>
            ...
            {[
              {
                step: '01',
                title: 'Ingest',
                body: 'Drop a source into raw/. The LLM reads it, writes a summary, updates entity and concept pages 跨越 the wiki, and flags anything that contradicts existing knowledge. A single source might touch 10\u201315 wiki 页内容。',
              },
              {
                step: '02',
                title: 'Query',
              ...
              },
              {
                step: '03',
                title: 'Lint',
                body: 'Run health checks over the wiki. Find inconsistent data, stale claims, orphan pages, missing cross-references. The LLM suggests new questions to ask and new 个来源的发现 to look for.',
              },
            ].map((item, i) => (
              <MotionDiv
                key={item.step}
